...
class OrderListScreen extends StatefulWidget {
  OrderListScreen({super.key, required this.userPref,required this.isOrderSucess});
      ...
      child: Scaffold(
        appBar: AppBar(
          leading: IconButton(
            ...
            onPressed: () =>{widget.isOrderSucess?Navigator.of(context).pushReplacement(MaterialPageRoute(
            ...
            child: StreamBuilder(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  ...
                  ordersModelList.sort((a, b) {
                    DateTime dateA =
                    dateFormat.parse(a.orderCreatedDate);
                    DateTime dateB =
                    dateFormat.parse(b.orderCreatedDate);
                    return dateB.compareTo(
                        dateA); // Compare DateTime objects
                  });
                            ...
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (BuildContext context) =>
                                      OrderDetailsScreen(
                                          ordersModel: ordersModelList[index],orderId: ordersModelList[index].orderID,)));
                            },
                            child: Container(
