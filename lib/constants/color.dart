...
const primaryColor = Color(0xFF34571A);
const accentColor = Color(0xFFF1CA76);
const cardColor = Color(0xFFf8f9f0);
const purple = Color(0xFFEBDDFC);
...
const Color borderColor = Color(0xffE7E7E8);
...
const greenBg =  Color(0xFFF3FDC9);

const orderPending = Color(0xFFFF0000);
const orderAccepted = Color(0xFF0FDC00);
const orderInProgress= Color(0xFFA500DC);
const orderCompleted= Color(0xFF1102C7);
...
double latitudeCurrent = 10.2771958;
...
String orderTypeTaxi = '3';

// orderType 1 -> Restaurant, Grocery, Make an Order
// orderType 2 -> PickUp & Delivery
// orderType 3 -> Taxi
